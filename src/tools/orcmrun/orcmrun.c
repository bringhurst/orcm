...
static int32_t orcm_master = 0;

/*
 * Globals
 */
struct orcmrun_globals_t orcmrun_globals;
static bool globals_init = false;

static opal_cmd_line_init_t cmd_line_init[] = {
    /* Various "obvious" options */
    { NULL, NULL, NULL, 'h', NULL, "help", 0,
      &orcmrun_globals.help, OPAL_CMD_LINE_TYPE_BOOL,
      "This help message" },
    { NULL, NULL, NULL, 'V', NULL, "version", 0,
      &orcmrun_globals.version, OPAL_CMD_LINE_TYPE_BOOL,
      "Print version and exit" },
    { NULL, NULL, NULL, 'v', NULL, "verbose", 0,
      &orcmrun_globals.verbose, OPAL_CMD_LINE_TYPE_BOOL,
      "Be verbose" },
    { "orte", "execute", "quiet", 'q', NULL, "quiet", 0,
      NULL, OPAL_CMD_LINE_TYPE_BOOL,
      "Suppress helpful messages" },
    { NULL, NULL, NULL, '\0', "report-pid", "report-pid", 1,
      &orcmrun_globals.report_pid, OPAL_CMD_LINE_TYPE_STRING,
      "Printout pid on stdout [-], stderr [+], or a file [anything else]" },
    { NULL, NULL, NULL, '\0', "report-uri", "report-uri", 1,
      &orcmrun_globals.report_uri, OPAL_CMD_LINE_TYPE_STRING,
      "Printout URI on stdout [-], stderr [+], or a file [anything else]" },
    
    /* orcm-specific options */
    { NULL, NULL, NULL, '\0', "dvm", "dvm", 1,
      &orcmrun_globals.sched, OPAL_CMD_LINE_TYPE_STRING,
      "ORCM DVM to be contacted [number or file:name of file containing it" },
    
    { NULL, NULL, NULL, '\0', "dvm-uri", "dvm-uri", 1,
      &orcmrun_globals.hnp_uri, OPAL_CMD_LINE_TYPE_STRING,
    ...
    { NULL, NULL, NULL, '\0', "stdin", "stdin", 1,
      &orcmrun_globals.stdin_target, OPAL_CMD_LINE_TYPE_STRING,
      "Specify procs to receive stdin [rank, all, none] (default: 0, indicating rank 0)" },
    
    /* Preload the binary on the remote machine */
    { NULL, NULL, NULL, 's', NULL, "preload-binary", 0,
      &orcmrun_globals.preload_binary, OPAL_CMD_LINE_TYPE_BOOL,
      "Preload the binary on the remote machine before starting the remote process." },

    /* Preload files on the remote machine */
    { NULL, NULL, NULL, '\0', NULL, "preload-files", 1,
      &orcmrun_globals.preload_files, OPAL_CMD_LINE_TYPE_STRING,
    ...
    { NULL, NULL, NULL, '\0', NULL, "preload-files-dest-dir", 1,
      &orcmrun_globals.preload_files_dest_dir, OPAL_CMD_LINE_TYPE_STRING,
    ...
    { NULL, NULL, NULL, '\0', NULL, "sstore-load", 1,
      &orcmrun_globals.sstore_load, OPAL_CMD_LINE_TYPE_STRING,
      "Internal Use Only! Tell SStore to preload a snapshot before launch." },
#endif

    /* Use an appfile */
    { NULL, NULL, NULL, '\0', NULL, "app", 1,
      &orcmrun_globals.appfile, OPAL_CMD_LINE_TYPE_STRING,
      "Provide an appfile; ignore all other command line options" },

    /* Number of processes; -c, -n, --n, -np, and --np are all
       synonyms */
    { NULL, NULL, NULL, 'c', "np", "np", 1,
      &orcmrun_globals.num_procs, OPAL_CMD_LINE_TYPE_INT,
    ...
    { NULL, NULL, NULL, '\0', "ompi-server", "ompi-server", 1,
      &orcmrun_globals.ompi_server, OPAL_CMD_LINE_TYPE_STRING,
    ...
    { NULL, NULL, NULL, '\0', "wait-for-server", "wait-for-server", 0,
      &orcmrun_globals.wait_for_server, OPAL_CMD_LINE_TYPE_BOOL,
    ...
    { NULL, NULL, NULL, '\0', "server-wait-time", "server-wait-time", 1,
      &orcmrun_globals.server_wait_timeout, OPAL_CMD_LINE_TYPE_INT,
    ...
    { NULL, NULL, NULL, '\0', "bynode", "bynode", 0,
      &orcmrun_globals.by_node, OPAL_CMD_LINE_TYPE_BOOL,
      "Whether to assign processes round-robin by node" },
    { NULL, NULL, NULL, '\0', "byslot", "byslot", 0,
      &orcmrun_globals.by_slot, OPAL_CMD_LINE_TYPE_BOOL,
    ...
    { NULL, NULL, NULL, '\0', "bysocket", "bysocket", 0,
      &orcmrun_globals.by_socket, OPAL_CMD_LINE_TYPE_BOOL,
    ...
    { NULL, NULL, NULL, '\0', "wdir", "wdir", 1,
      &orcmrun_globals.wdir, OPAL_CMD_LINE_TYPE_STRING,
      "Set the working directory of the started processes" },
    { NULL, NULL, NULL, '\0', "wd", "wd", 1,
      &orcmrun_globals.wdir, OPAL_CMD_LINE_TYPE_STRING,
      "Synonym for --wdir" },
    { NULL, NULL, NULL, '\0', "path", "path", 1,
      &orcmrun_globals.path, OPAL_CMD_LINE_TYPE_STRING,
      "PATH to be used to look for executables to start processes" },

    /* User-level debugger arguments */
    { NULL, NULL, NULL, '\0', "tv", "tv", 0,
      &orcmrun_globals.debugger, OPAL_CMD_LINE_TYPE_BOOL,
    ...
    { NULL, NULL, NULL, '\0', "tmpdir", "tmpdir", 1,
      ...
      "Set the root for the session directory tree for orcmrun ONLY" },
    ...
    { NULL, NULL, NULL, '\0', "disable-recovery", "disable-recovery", 0,
      &orcmrun_globals.disable_recovery, OPAL_CMD_LINE_TYPE_BOOL,
...
int orcmrun(int argc, char *argv[])
{
    ...
    /* force the debugger symbols to be included in orcmrun.
    ...
    if (ORTE_SUCCESS != parse_globals(argc, argv, &cmd_line)) {
        goto DONE;
    }
    ...
    if (0 == strcmp(orcmrun_globals.stdin_target, "all")) {
        jdata->stdin_target = ORTE_VPID_WILDCARD;
    } else if (0 == strcmp(orcmrun_globals.stdin_target, "none")) {
        jdata->stdin_target = ORTE_VPID_INVALID;
    } else {
        jdata->stdin_target = strtoul(orcmrun_globals.stdin_target, NULL, 10);
    }
    ...
    if (0 == jdata->num_apps) {
        ...
        orte_show_help("help-orcmrun.txt", "orcmrun:nothing-to-do",
                       true, orte_basename);
    ...
    /* Intialize ORCM as a TOOL, DEBUGGR HOST, and IOF endpoint */
    if (ORTE_SUCCESS != (rc = orcm_init(ORCM_TOOL | ORCM_DEBUGGER_HOST | ORCM_IOF_ENDPT))) {
        ORTE_ERROR_LOG(rc);
        return rc;
    }    

    /* check for request to report uri */
    if (NULL != orcmrun_globals.report_uri) {
        FILE *fp;
        char *rml_uri;
        rml_uri = orte_rml.get_contact_info();
        if (0 == strcmp(orcmrun_globals.report_uri, "-")) {
            /* if '-', then output to stdout */
            printf("%s\n",  (NULL == rml_uri) ? "NULL" : rml_uri);
        } else if (0 == strcmp(orcmrun_globals.report_uri, "+")) {
            /* if '+', output to stderr */
            fprintf(stderr, "%s\n",  (NULL == rml_uri) ? "NULL" : rml_uri);
        } else {
            fp = fopen(orcmrun_globals.report_uri, "w");
            if (NULL == fp) {
                orte_show_help("help-orcmrun.txt", "orcmrun:write_file", false,
                               orte_basename, "uri", orcmrun_globals.report_uri);
                exit(0);
            }
            fprintf(fp, "%s\n", (NULL == rml_uri) ? "NULL" : rml_uri);
            fclose(fp);
    ...
    */
    ...
    if (NULL != app && NULL != app->prefix_dir) {
    ...
    if (ORTE_SUCCESS != (rc = orte_pre_condition_transports(jdata))) {
        ORTE_ERROR_LOG(rc);
        orte_show_help("help-orcmrun.txt", "orcmrun:precondition", false,
    ...
    if (NULL != ompi_server) {
         ...
         */
        if (orcmrun_globals.wait_for_server) {
            /* ping the server */
            struct timeval timeout;
            timeout.tv_sec = orcmrun_globals.server_wait_timeout;
            timeout.tv_usec = 0;
            if (ORTE_SUCCESS != (rc = orte_rml.ping(ompi_server, &timeout))) {
                /* try it one more time */
                if (ORTE_SUCCESS != (rc = orte_rml.ping(ompi_server, &timeout))) {
                    /* okay give up */
                    orte_show_help("help-orcmrun.txt", "orcmrun:server-not-found", true,
                                   orte_basename, ompi_server,
                                   (long)orcmrun_globals.server_wait_timeout,
                                   ORTE_ERROR_NAME(rc));
                    ORTE_UPDATE_EXIT_STATUS(ORTE_ERROR_DEFAULT_EXIT_CODE);
                    goto DONE;
                }
    ...
    if (ORCM_SUCCESS != (rc = orcm_pnp.announce("orcmrun", "0.1", "alpha", NULL))) {
        ORTE_ERROR_LOG(rc);
        goto DONE;
    }
    ...
    /* ensure we define the dvm */
    if (NULL != orcmrun_globals.hnp_uri) {
        orcm_master = ORTE_JOB_FAMILY(ORTE_PROC_MY_HNP->jobid);
    }

    /* indicate the scheduler to be used */
    jfam = orcm_master & 0x0000ffff;
    ...
    /* tell orcm to spawn the job */
    if (ORCM_SUCCESS != (rc = orcm_pnp.output(ORCM_PNP_GROUP_OUTPUT_CHANNEL,
                     ...
                     opal_buffer_t *buf, void *cbdata)
{
    ...
    if (0 == rc) {
        ...
        opal_output(0, "ERROR ON LAUNCH: %s", ORTE_ERROR_NAME(rc));
        orte_quit();
    }
}
...
static int init_globals(void)
{
    ...
    if (!globals_init) {
        OBJ_CONSTRUCT(&orcmrun_globals.lock, opal_mutex_t);
        orcmrun_globals.sched = NULL;
        orcmrun_globals.hnp_uri = NULL;
        orcmrun_globals.env_val =     NULL;
        orcmrun_globals.appfile =     NULL;
        orcmrun_globals.wdir =        NULL;
        orcmrun_globals.path =        NULL;
        orcmrun_globals.ompi_server = NULL;
        orcmrun_globals.wait_for_server = false;
        orcmrun_globals.server_wait_timeout = 10;
        orcmrun_globals.stdin_target = "0";
        orcmrun_globals.report_pid        = NULL;
        orcmrun_globals.report_uri        = NULL;
        orcmrun_globals.disable_recovery = false;
    }

    /* Reset the other fields every time */

    orcmrun_globals.help                       = false;
    orcmrun_globals.version                    = false;
    orcmrun_globals.verbose                    = false;
    orcmrun_globals.by_node                    = false;
    orcmrun_globals.by_slot                    = false;
    orcmrun_globals.by_board                   = false;
    orcmrun_globals.by_socket                  = false;
    orcmrun_globals.bind_to_core               = false;
    orcmrun_globals.bind_to_board              = false;
    orcmrun_globals.bind_to_socket             = false;
    orcmrun_globals.debugger                   = false;
    orcmrun_globals.num_procs                  =  0;
    if( NULL != orcmrun_globals.env_val )
        free( orcmrun_globals.env_val );
    orcmrun_globals.env_val =     NULL;
    if( NULL != orcmrun_globals.appfile )
        free( orcmrun_globals.appfile );
    orcmrun_globals.appfile =     NULL;
    if( NULL != orcmrun_globals.wdir )
        free( orcmrun_globals.wdir );
    orcmrun_globals.wdir =        NULL;
    if( NULL != orcmrun_globals.path )
        free( orcmrun_globals.path );
    orcmrun_globals.path =        NULL;

    orcmrun_globals.preload_binary = false;
    orcmrun_globals.preload_files  = NULL;
    orcmrun_globals.preload_files_dest_dir = NULL;

#if OPAL_ENABLE_FT_CR == 1
    orcmrun_globals.sstore_load = NULL;
#endif
...
static int parse_globals(int argc, char* argv[], opal_cmd_line_t *cmd_line)
{
    ...
    if (orcmrun_globals.version && 
        !(1 == argc || orcmrun_globals.help)) {
        ...
        orte_show_help("help-orcmrun.txt", "orcmrun:version", false,
    ...
    if (1 == argc || orcmrun_globals.help) {
        char *args = NULL;
        char *project_name = NULL;
        if (0 == strcmp(orte_basename, "mpirun")) {
            project_name = "Open MPI";
        ...
        orte_show_help("help-orcmrun.txt", "orcmrun:usage", false,
                       orte_basename, project_name, OPAL_VERSION,
                       orte_basename, args,
                       PACKAGE_BUGREPORT);
        free(args);
    ...
    if (NULL != orcmrun_globals.report_pid) {
        FILE *fp;
        if (0 == strcmp(orcmrun_globals.report_pid, "-")) {
            /* if '-', then output to stdout */
            printf("%d\n", (int)getpid());
        } else if (0 == strcmp(orcmrun_globals.report_pid, "+")) {
            /* if '+', output to stderr */
            fprintf(stderr, "%d\n", (int)getpid());
        } else {
            fp = fopen(orcmrun_globals.report_pid, "w");
            if (NULL == fp) {
                orte_show_help("help-orcmrun.txt", "orcmrun:write_file", false,
                               orte_basename, "pid", orcmrun_globals.report_pid);
                exit(0);
            }
            fprintf(fp, "%d\n", (int)getpid());
            fclose(fp);
    ...
    if (orcmrun_globals.debugger) {
        run_debugger(orte_basename, cmd_line, argc, argv, orcmrun_globals.num_procs);
    }

    /* extract any rank assignment policy directives */
    if (orcmrun_globals.by_node) {
        ORTE_SET_MAPPING_POLICY(ORTE_MAPPING_BYNODE);
    } else if (orcmrun_globals.by_board) {
        ORTE_SET_MAPPING_POLICY(ORTE_MAPPING_BYBOARD);
    } else if (orcmrun_globals.by_socket) {
        ORTE_SET_MAPPING_POLICY(ORTE_MAPPING_BYSOCKET);
    } else if (orcmrun_globals.by_slot) {
    ...
    if (orcmrun_globals.bind_to_socket) {
        ORTE_SET_BINDING_POLICY(ORTE_BIND_TO_SOCKET);
    } else if (orcmrun_globals.bind_to_board) {
        ORTE_SET_BINDING_POLICY(ORTE_BIND_TO_BOARD);
    } else if (orcmrun_globals.bind_to_core) {
        ORTE_SET_BINDING_POLICY(ORTE_BIND_TO_CORE);
    } else if (orcmrun_globals.bind_to_none) {
    ...
    if (orcmrun_globals.disable_recovery) {
    ...
    if (NULL == orcmrun_globals.sched && NULL == orcmrun_globals.hnp_uri) {
        opal_output(0, "Must specify ORCM DVM to be contacted");
        return ORTE_ERROR;
    }
    if (NULL != orcmrun_globals.sched) {
        if (0 == strncmp(orcmrun_globals.sched, "file", strlen("file")) ||
            0 == strncmp(orcmrun_globals.sched, "FILE", strlen("FILE"))) {
            char input[1024], *filename;
            FILE *fp;
            
            /* it is a file - get the filename */
            filename = strchr(orcmrun_globals.sched, ':');
            if (NULL == filename) {
                /* filename is not correctly formatted */
                orte_show_help("help-openrcm-runtime.txt", "hnp-filename-bad", true, "scheduler", orcmrun_globals.sched);
                return ORTE_ERROR;
            }
            ...
            orcm_master = strtoul(input, NULL, 10);
        } else {
            /* should just be the scheduler itself */
            orcm_master = strtoul(orcmrun_globals.sched, NULL, 10);
        }
    }
     ...
     */
    if (NULL != orcmrun_globals.hnp_uri) {
        if (0 == strncmp(orcmrun_globals.hnp_uri, "file", strlen("file")) ||
            0 == strncmp(orcmrun_globals.hnp_uri, "FILE", strlen("FILE"))) {
            char input[1024], *filename;
            FILE *fp;
            
            /* it is a file - get the filename */
            filename = strchr(orcmrun_globals.hnp_uri, ':');
            if (NULL == filename) {
                /* filename is not correctly formatted */
                orte_show_help("help-openrcm-runtime.txt", "hnp-filename-bad", true, "uri", orcmrun_globals.hnp_uri);
                return ORTE_ERROR;
            }
            ++filename; /* space past the : */
            ...
            orte_process_info.my_hnp_uri = strdup(orcmrun_globals.hnp_uri);
        }
    }
...
static int parse_locals(int argc, char* argv[])
{
    ...
    if (NULL != orcmrun_globals.ompi_server) {
         ...
         */
        if (0 == strncmp(orcmrun_globals.ompi_server, "file", strlen("file")) ||
            0 == strncmp(orcmrun_globals.ompi_server, "FILE", strlen("FILE"))) {
            char input[1024], *filename;
            FILE *fp;
            
            /* it is a file - get the filename */
            filename = strchr(orcmrun_globals.ompi_server, ':');
            if (NULL == filename) {
                /* filename is not correctly formatted */
                orte_show_help("help-orcmrun.txt", "orcmrun:ompi-server-filename-bad", true,
                               orte_basename, orcmrun_globals.ompi_server);
                exit(1);
            }
            ++filename; /* space past the : */
            ...
            if (0 >= strlen(filename)) {
                /* they forgot to give us the name! */
                orte_show_help("help-orcmrun.txt", "orcmrun:ompi-server-filename-missing", true,
                               orte_basename, orcmrun_globals.ompi_server);
                exit(1);
            }
            ...
            fp = fopen(filename, "r");
            if (NULL == fp) { /* can't find or read file! */
                orte_show_help("help-orcmrun.txt", "orcmrun:ompi-server-filename-access", true,
                               orte_basename, orcmrun_globals.ompi_server);
                exit(1);
            }
            if (NULL == fgets(input, 1024, fp)) {
                /* something malformed about file */
                fclose(fp);
                orte_show_help("help-orcmrun.txt", "orcmrun:ompi-server-file-bad", true,
                               orte_basename, orcmrun_globals.ompi_server,
                               orte_basename);
                exit(1);
            }
        ...
        } else if (0 == strncmp(orcmrun_globals.ompi_server, "pid", strlen("pid")) ||
                   0 == strncmp(orcmrun_globals.ompi_server, "PID", strlen("PID"))) {
            ...
            ptr = strchr(orcmrun_globals.ompi_server, ':');
            if (NULL == ptr) {
                /* pid is not correctly formatted */
                orte_show_help("help-orcmrun.txt", "orcmrun:ompi-server-pid-bad", true,
                               orte_basename, orte_basename,
                               orcmrun_globals.ompi_server, orte_basename);
                exit(1);
            }
            ++ptr; /* space past the : */
            ...
            if (ORTE_SUCCESS != (rc = orte_session_dir_get_name(NULL, &orte_process_info.tmpdir_base,
                                                                ...
                                                                NULL, NULL, NULL))) {
                orte_show_help("help-orcmrun.txt", "orcmrun:ompi-server-could-not-get-hnp-list", true,
                               orte_basename, orte_basename);
                exit(1);
            }
            ...
            orte_show_help("help-orcmrun.txt", "orcmrun:ompi-server-pid-not-found", true,
                           orte_basename, orte_basename, pid, orcmrun_globals.ompi_server,
                           orte_basename);
        ...
        hnp_found:
            ...
            ompi_server = strdup(orcmrun_globals.ompi_server);
        }
    }
    ...
    /* Now take a subset of the MCA params and set them as MCA
       overrides here in orcmrun (so that when we orte_init() later,
       all the components see these MCA params).  Here's how we decide
       which subset of the MCA params we set here in orcmrun:
                        ...
                        if (0 == strcmp(argv[i+2], orted_cmd_line[j+1])) {
                            ...
                            for (k=0; NULL != no_dups[k]; k++) {
                                if (0 == strcmp(no_dups[k], argv[i+1])) {
                                     ...
                                     */
                                    orte_show_help("help-orcmrun.txt", "orcmrun:conflicting-params",
 ...
 * specific case:
 *
 *   orcmrun --mca foo bar -app appfile
 *
 ...
 *
 *   orcmrun --mca foo bar -np 4 hostname
 *
                      ...
                      bool *made_app, char ***app_env)
{
    ...
    *made_app = false;
    ...
    if (NULL != orcmrun_globals.appfile) {
        OBJ_DESTRUCT(&cmd_line);
        return parse_appfile(strdup(orcmrun_globals.appfile), app_env);
    }
    ...
    if (0 == count) {
        orte_show_help("help-orcmrun.txt", "orcmrun:executable-not-specified",
    ...
    if (NULL != orcmrun_globals.path) {
        asprintf(&value, "OMPI_exec_path=%s", orcmrun_globals.path);
        opal_argv_append_nosize(&app->env, value);
        free(value);
    }
    ...
    if (NULL != orcmrun_globals.wdir) {
        ...
        if (opal_path_is_absolute(orcmrun_globals.wdir)) {
            app->cwd = strdup(orcmrun_globals.wdir);
        } else {
            /* get the cwd */
            if (OPAL_SUCCESS != (rc = opal_getcwd(cwd, sizeof(cwd)))) {
                orte_show_help("help-orcmrun.txt", "orcmrun:init-failure",
                               true, "get the cwd", rc);
                goto cleanup;
            }
            /* construct the absolute path */
            app->cwd = opal_os_path(false, cwd, orcmrun_globals.wdir, NULL);
        }
    ...
    if (opal_cmd_line_is_taken(&cmd_line, "prefix") ||
        ...
        /* The --prefix option takes precedence over /path/to/orcmrun */
        if (opal_cmd_line_is_taken(&cmd_line, "prefix")) {
        ...
        /* --enable-orcmrun-prefix-default was given to orcmrun */
        else {
        ...
        if (NULL != param) {
            ...
            while (0 == strcmp (OPAL_PATH_SEP, &(param[param_len-1]))) {
                ...
                param_len--;
                if (0 == param_len) {
                    orte_show_help("help-orcmrun.txt", "orcmrun:empty-prefix",
                                   true, orte_basename, orte_basename);
    ...
    if (0 < (j = opal_cmd_line_get_ninsts(&cmd_line, "hostfile"))) {
        if(1 < j) {
            orte_show_help("help-orcmrun.txt", "orcmrun:multiple-hostfiles",
    ...
    app->num_procs = (orte_std_cntr_t)orcmrun_globals.num_procs;
    ...
    */
    ...
    if (0 < total_num_apps && have_zero_np) {
         ...
         */
        orte_show_help("help-orcmrun.txt", "orcmrun:multi-apps-and-zero-np",
                       true, orte_basename, NULL);
        return ORTE_ERR_FATAL;
    }
    ...
    app->preload_binary = orcmrun_globals.preload_binary;
    if( NULL != orcmrun_globals.preload_files)
        app->preload_files  = strdup(orcmrun_globals.preload_files);
    else 
        app->preload_files = NULL;
    if( NULL != orcmrun_globals.preload_files_dest_dir)
        app->preload_files_dest_dir  = strdup(orcmrun_globals.preload_files_dest_dir);
    else 
        app->preload_files_dest_dir = NULL;

#if OPAL_ENABLE_FT_CR == 1
    if( NULL != orcmrun_globals.sstore_load ) {
        app->sstore_load = strdup(orcmrun_globals.sstore_load);
    } else {
    ...
    /* Do not try to find argv[0] here -- the starter is responsible
       ...
       the node where orcmrun is executing.  So just strdup() argv[0]
       into app. */

    app->app = strdup(app->argv[0]);
    if (NULL == app->app) {
        orte_show_help("help-orcmrun.txt", "orcmrun:call-failed",
...
static int parse_appfile(char *filename, char ***env)
{
    ...
    fp = fopen(filename, "r");
    if (NULL == fp) {
        orte_show_help("help-orcmrun.txt", "orcmrun:appfile-not-found", true,
                       filename);
    ...
    do {
        ...
        /* We need a bogus argv[0] (because when argv comes in from
           the command line, argv[0] is "orcmrun", so the parsing
        ...
        if (argc > 0) {
            ...
            /* Create a temporary env to use in the recursive call --
               ...
               case:
                   ...
                   orcmrun --mca foo bar --appfile file
                   ...
                   int argc, char **argv, char ***new_argv, int num_procs) 
{
    ...
    for (i = 0; i < (int) strlen(line); ++i) {
        ...
        } else if (0 == strncmp(line + i, "@orcmrun@", 9)) {
            line[i] = '\0';
        ...
        } else if (0 == strncmp(line + i, "@orcmrun_args@", 14)) {
            line[i] = '\0';
    ...
    *new_argv = opal_argv_split(line, ' ');
    ...
    if (NULL != tmp) {
        ...
        if (used_num_procs && 0 == num_procs) {
            orte_show_help("help-orcmrun.txt", "debugger requires -np",
        ...
        /* Some debuggers do not support launching MPMD */
            ...
            orte_show_help("help-orcmrun.txt", 
                           "debugger only accepts single app", true,
                           (*new_argv)[0], (*new_argv)[0]);
            /* Fall through to free / fail, below */
        }

        /* Some debuggers do not use orcmrun/mpirun, and therefore
                         ...
                         int argc, char *argv[], int num_procs)
{
    ...
    if (id < 0) {
        orte_show_help("help-orcmrun.txt", "debugger-mca-param-not-found", 
                       true);
        exit(1);
    }
    value = NULL;
    ...
    if (NULL == value) {
        orte_show_help("help-orcmrun.txt", "debugger-orte_base_user_debugger-empty",
                       true);
        exit(1);
    }
    ...
    if (NULL == lines[i]) {
        orte_show_help("help-orcmrun.txt", "debugger-not-found", true);
        exit(1);
    }
    ...
    orte_show_help("help-orcmrun.txt", "debugger-exec-failed",
