 ...
 */
void orcm_info_out(const char *pretty_message, const char *plain_message, const char *value)
{
    ...
    if (orcm_info_pretty && NULL != pretty_message) {
                       ...
                       int value)
{
    ...
    orcm_info_out(pretty_message, plain_message, valstr);
    free(valstr);
}
