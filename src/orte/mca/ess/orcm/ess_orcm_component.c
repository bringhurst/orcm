 ...
 */
orte_ess_orcm_component_t mca_ess_orcm_component = {
    {
        {
...
{
    mca_base_component_t *c = &mca_ess_orcm_component.super.base_version;

    mca_base_param_reg_int(c, "max_slots",
                           "Max #slots/rack (must be > 0)",
                           false, false, 38, &mca_ess_orcm_component.max_slots);
