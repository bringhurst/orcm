 ...
 */
int orcm_sensor_base_select(void)
{
    mca_base_component_list_item_t *cli = NULL;
    mca_base_component_t *component = NULL;
    mca_base_module_t *module = NULL;
    orcm_sensor_base_module_t *nmodule;
    ...
    for (item = opal_list_get_first(&mca_sensor_base_components_available);
        ...
        if (NULL == component->mca_query_component) {
            opal_output_verbose(5, orcm_sensor_base_output,
        ...
        nmodule = (orcm_sensor_base_module_t*) module;
        ...
        pair = OBJ_NEW(orcm_sensor_base_selected_pair_t);
        pair->component = (orcm_sensor_base_component_t*) component;
        pair->module = nmodule;
        
        /* Add it to the list of operational sensors */
        opal_list_append(&orcm_sensor_base_selected_modules, &(pair->super));
    }
