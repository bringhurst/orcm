...
enum {
    ...
    ORTE_PNP_TAG_DATA           = ORTE_RMCAST_TAG_DATA,
    ORTE_PNP_TAG_CMD_ACK        = ORTE_RMCAST_TAG_CMD_ACK,
    ORTE_PNP_TAG_HEARTBEAT      = ORTE_RMCAST_TAG_HEARTBEAT,
...
enum {
    ...
    ORTE_PNP_DATA_SERVER_CHANNEL    = ORTE_RMCAST_DATA_SERVER_CHANNEL
};
